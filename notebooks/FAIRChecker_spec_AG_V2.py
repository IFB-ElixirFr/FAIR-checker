...
FC_R_A1_1 = Requirement("FC_R_A1.1",
...
FC_R_A1_2 = Requirement("FC_R_A1.2",
...
FC_R_R1_1 = Requirement("FC_R_R1.1",
...
FC_R_R1_2 = Requirement("FC_R_R1.2",
...
FC_R_R1_3 = Requirement("FC_R_R1.3",
                       Description = """Weak: FAIR-Checker verifies that at least one used ontology class or property are known in major ontology registries (OLS, BioPortal, LOV)
...
# --------------------------------------
FC_I_F1A = Implementation("FC_I_F1A",
                       ...
                       MinimalPatternsForSuccess ={
                                0:   [["# FC_I_F1A > Status code is different than 200, thus, the resource is not reachable."]],
                                1: [[]],
...
FC_I_F1B = Implementation("FC_I_F1B",
                       Version ="",
                       URL = "https://github.com/IFB-ElixirFr/FAIR-checker/blob/master/metrics/F1B_Impl.py",
                       MinimalPatternsForSuccess ={
                                0:   [[]],
                                1: [["# FC_I_F1B > at least one namespace from identifiers.org is used in metadata"]],
...
FC_I_F2A = Implementation("FC_I_F2A",
                       Version ="",
                       ...
                       EquivalentPropertiesImplem = [{"dct:title",  "dct:description", "dcat:accessURL", "dcat:downloadURL", "dcat:endpointDescription", "dcat:endpointURL"}],
...
FC_I_F2B = Implementation("FC_I_F2B",
                       Version ="",
                       URL = "https://github.com/IFB-ElixirFr/FAIR-checker/blob/master/metrics/F2B_Impl.py",
                       MinimalPatternsForSuccess ={
                                0:   [["# FC_I_F2B > No classes and properties are known in major ontology registries (OLS, BioPortal, LOV)"]],
                                1:   [["# FC_I_F2B > at least one used ontology classe or property known in major ontology registries (OLS, BioPortal, LOV)"]],
                                2  : [["# FC_I_F2B > All classes and properties are known in major ontology registries (OLS, BioPortal, LOV)"]]
                        },
                       ScoreMin = 0,
                       ScoreMax = 2,
                       ScoreIntervalNature = "Discrete",
...
FC_I_A1_1 = Implementation("FC_I_A1.1",
                       Version ="",
                       URL = "https://github.com/IFB-ElixirFr/FAIR-checker/blob/master/metrics/A11_Impl.py",
                       MinimalPatternsForSuccess ={
                                0:   [["# FC_I_A1.1 > The resource seems to not be using HTTP protocol, or can't be found: 404 error"]],
                                1: [[]],
...
FC_I_A1_2 = Implementation("FC_I_A1.2",
                       Version ="",
                       ...
                       EquivalentPropertiesImplem = [{"odrl:hasPolicy", "dct:rights", "dct:accessRights", "dct:license", "schema:license"}],
...
FC_I_I1 = Implementation("FC_I_I1",
                       Version ="",
...
FC_I_I2 = Implementation("FC_I_I2",
                       Version ="",
                       URL = "",
                       MinimalPatternsForSuccess ={
                                0: [[]],
                                1: [["# FC_I_I2 > at least one used ontology class or property are known in major ontology registries (OLS, BioPortal, LOV)"]],
                                2: [["# FC_I_I2 > all used ontology classes or properties are known in major ontology registries (OLS, BioPortal, LOV)"]]
                        },
                       ScoreMin = 0,
                       ScoreMax = 2 ,
                       ScoreIntervalNature = "Discrete",
...
FC_I_I3 = Implementation("FC_I_I3",
                       Version ="",
                       URL = "https://github.com/IFB-ElixirFr/FAIR-checker/blob/master/metrics/I3_Impl.py",
                       MinimalPatternsForSuccess ={
                                0:   [[]],
                                1: [[]],
                                2  : [["# FC_I_I3 > At least 3 different domains were found in metadata",
...
FC_I_R1_1 = Implementation("FC_I_R1.1",
                       Version ="",
                       ...
                       EquivalentPropertiesImplem = [{"schema:license", "dct:license", "doap:license", "dbpedia-owl:license", "cc:license", "xhv:license", "sto:license", "nie:license"}],
                       ScoreMin = 0,
                       ScoreMax = 2 ,
                       ScoreIntervalNature = "Discrete",
                       NbPossibleScores = 2,
...
FC_I_R1_2 = Implementation("FC_I_R1.2",
                       Version ="",
...
FC_I_R1_3 = Implementation("FC_I_R1.3",
                       Version ="",
                       URL = "https://github.com/IFB-ElixirFr/FAIR-checker/blob/master/metrics/R13_Impl.py",
                       MinimalPatternsForSuccess ={
                                0: [["# FC_I_F2B > No classes and properties are known in major ontology registries (OLS, BioPortal, LOV)"]],
                                1: [["# FC_I_R1.3 > at least one used ontology class or property are known in major ontology registries (OLS, BioPortal, LOV)"]],
                                2: [["# FC_I_R1.3 > all used ontology classes or properties are known in major ontology registries (OLS, BioPortal, LOV)"]]
                        },
                       ScoreMin = 0,
                       ScoreMax = 2 ,
                       ScoreIntervalNature = "Discrete",
...
FAIRChecker_V2["Reusable"]["R1"]["R1.3"]["FC_R_R1.3"].isImplementedBy(FC_I_R1_3)        # Délégation
